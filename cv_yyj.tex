...
\begin{rSection}{Employment}
	...
	\begin{rSubsection}{Research Assistant}{March, 2026 - Present}{The University of Edinburgh}{Edinburgh, Scotland}
		\item Undertake research related to the development of the ATLAS sub-system within the broader environment of the ADIA2 project.
	\end{rSubsection}
...
\begin{rSection}{Research Experience}
	...
	\begin{rSubsection}{ASOCat}{Sept, 2022 - Sept, 2025}{The University of Edinburgh}{PhD Sub-project}
		\item Investigating to build a Copycat-based cognitive model compatible with an associative memory chip
		\item Designed and implementing its software/hardware interface
	\end{rSubsection}
