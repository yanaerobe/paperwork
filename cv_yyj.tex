...
\begin{rSection}{Publications}
	...
	% NOTE: WIP
	% \begin{rSubsection}{Views: A Hardware-friendly Graph Database Architecture For Storing Semantic Information}{TODO}{Proceedings of the Royal Society A}{}
	% 	\item Authors: Yanjun Yang, Adrian Wheeldon, Themis Prodromakis and Alex Serb
	% \end{rSubsection}
	...
	% 	\item Authors: Javad Heydarian, Yanjun Yang, Chris Giotis, Alex Serb
	% \end{rSubsection}
	...
	% 	\item Authors: Yihan Pan, Yanjun Yang, Adrian Wheeldon, Khaled Humood, Mohammed Mughal, Grahame Reynolds, Themis Prodromakis, and Alexantrou Serb
	% \end{rSubsection}
	...
	\begin{rSubsection}{A Resource-efficient Dually-addressable Memory Architecture on FPGA}{May, 2025}{ISCAS 2025}{London, United Kingdom}
		\item Authors: Yanjun Yang, Christos Giotis, Themis Prodromakis and Alex Serb
	\end{rSubsection}
	
	\begin{rSubsection}{A Modular Graph Database Accelerator}{September, 2024}{ECML PKDD 2024}{Vilnius, Lituania}
		\item Authors: Yihan Pan, Adrian Wheeldon, Yanjun Yang, Khaled Humood, Mohammed Mughal, Grahame Reynolds, Themis Prodromakis, and Alexantrou Serb
