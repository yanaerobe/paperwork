...
\begin{rSection}{Publications}
	...
	% NOTE: WIP
	% \begin{rSubsection}{\textit{Views}: A Hardware-friendly Graph Database Architecture For Storing Semantic Information}{TODO}{Proceedings of the Royal Society A}{}
	% 	\item Authors: \textbf{Yanjun Yang}, Adrian Wheeldon, Yihan Pan, Spyros Stathopoulos, Themis Prodromakis and Alex Serb
	% \end{rSubsection}
	
	% \begin{rSubsection}{High-Performance Graph Query Acceleration on FPGAs Using\\ASOCA-GDB}{Nov, 2025}{ICECS 2025}{Marrakech, Morocco}
	% 	\item Authors: Javad Heydarian, \textbf{Yanjun Yang}, Chris Giotis, Alex Serb
	% \end{rSubsection}
...
\begin{rSection}{Seminars \& Talks}
	...
	% \begin{rSubsection}{CEF Chat}{2025}{Centre for Electronics Frontiers}{Edinburgh, Scotland}
